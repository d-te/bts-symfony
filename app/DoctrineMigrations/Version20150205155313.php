   ...
   public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE issue (id INT AUTO_INCREMENT NOT NULL, reporter_id INT DEFAULT NULL, project_id INT DEFAULT NULL, status_id INT DEFAULT NULL, assignee_id INT DEFAULT NULL, priority_id INT DEFAULT NULL, resolution_id INT DEFAULT NULL, summary VARCHAR(255) NOT NULL, code VARCHAR(20) NOT NULL, description VARCHAR(255) NOT NULL, type TINYINT(1) NOT NULL, parent_id INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_12AD233EE1CFE6F5 (reporter_id), INDEX IDX_12AD233E166D1F9C (project_id), INDEX IDX_12AD233E6BF700BD (status_id), INDEX IDX_12AD233E59EC7D60 (assignee_id), INDEX IDX_12AD233E497B19F9 (priority_id), INDEX IDX_12AD233E12A1C43A (resolution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
