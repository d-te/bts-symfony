 ...
 * ProjectMembers
 *
 * @ORM\Table(name="project_members", uniqueConstraints={@ORM\UniqueConstraint(name="project_id_user_id", columns={"project_id", "user_id"})}, indexes={@ORM\Index(name="IDX_D3BEDE9AA76ED395", columns={"user_id"}), @ORM\Index(name="IDX_D3BEDE9A166D1F9C", columns={"project_id"})})
 * @ORM\Entity
 */
