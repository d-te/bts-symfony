 ...
 * UserRoles
 *
 * @ORM\Table(name="user_roles", uniqueConstraints={@ORM\UniqueConstraint(name="user_id_role_id", columns={"user_id", "role_id"})}, indexes={@ORM\Index(name="IDX_54FCD59FD60322AC", columns={"role_id"}), @ORM\Index(name="IDX_54FCD59FA76ED395", columns={"user_id"})})
 * @ORM\Entity
 */
class UserRoles
{
